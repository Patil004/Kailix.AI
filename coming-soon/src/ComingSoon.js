...
export default function ComingSoon() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white px-4">
      ...
      {!submitted ? (
        <form
          action="https://getform.io/f/bjjrydwb"
          method="POST"
        ...
        >
          <input
            ...
            className="flex-1 px-4 py-2 rounded-2xl text-black focus:outline-none"
            required
          />
          <button
            type="submit"
      ...
      <div className="mt-12 text-center max-w-xl">
        <p className="text-gray-400">
          We help creators, learners, and professionals unlock the full power of
          AI tools without wasting hours guessing prompts.
        </p>
      </div>
